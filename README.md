...
👨‍💻 I'm a Senior Full Stack Developer with 8+ years of experience specializing in MEAN & MERN stack development, along with a strong background in building scalable and efficient web applications using Angular, Node.js, Nest.js, and Python frameworks (Django, Flask, FastAPI).
...
💼 What I'm Working On
- Building scalable and high-performance web applications using the MEAN & MERN stack (Angular, React, Node.js, Nest.js).
